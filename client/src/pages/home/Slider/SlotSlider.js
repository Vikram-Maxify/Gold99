...
import icon from "../../../assets/slots_a-de9dd5ee.svg";
import {
  gameListByGameType,
...
const SlotSlider = () => {
  ...
  const [game_type, setGame_type] = useState("Slot Game");
    ...
    <div className="w-full py-2">
      ...
      <div className="flex justify-between items-center my-2">
        ...
        <div className="flex items-center gap-2">
          <Link
            to="home/AllOnlineGames?game=Slots"
            className="text-[12px] text-black blue-linear px-1.5 py-1.5 rounded-md transition-colors"
          >
            Detail
          </Link>
          <button className="popular3-prev rounded-md blue-linear text-black p-1.5 transition-colors">
            <svg
          ...
          <button className="popular3-next rounded-md blue-linear p-1.5 transition-colors">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-4 w-4 text-black"
              fill="none"
      ...
      <Swiper
        ...
        // }}
        navigation={{
          nextEl: ".popular3-next",
          prevEl: ".popular3-prev",
        }}
            ...
            <SwiperSlide key={index}>
              ...
              >
                <img
                  src={item.icon}
                  alt="game"
                  className="h-[19vh] object-fill w-full"
