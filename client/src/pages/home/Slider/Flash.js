...
import icon from "../../../assets/mini-4ae18c6b.png";
import {
  gameListByGameType,
  launchGame,
} from "../../../store/reducer/spribeGameReducer";
import { gameListByProviderAndGametype } from "../../../store/reducer/spribeGameReducer";
    ...
    <div className="w-full py-2">
      ...
      <div className="flex justify-between items-center my-2">
        <h2 className="text-base font-semibold text-[#00ecbe] flex item-center">
          <span>
            <img src={icon} className="w-[30px] h-auto mr-2" alt="icon" />
          </span>
          Mini Game
        </h2>
