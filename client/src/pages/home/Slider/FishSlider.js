...
import icon from "../../../assets/fishing_a-8b8f8c2c.png";
...
const FishSlider = () => {
  ...
  const [game_type, setGame_type] = useState("Fish Game");
    ...
    <div className="w-full py-2">
      <div className="flex justify-between items-center my-2">
        ...
        <div className="flex items-center gap-2">
          ...
          <button className="popular2-prev rounded-md blue-linear text-black p-1.5 transition-colors">
            <svg
          ...
          <button className="popular2-next rounded-md blue-linear p-1.5 transition-colors">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-4 w-4 text-black"
              fill="none"
      ...
      <Swiper
        ...
        // }}
        navigation={{
          nextEl: ".popular2-next",
          prevEl: ".popular2-prev",
        }}
